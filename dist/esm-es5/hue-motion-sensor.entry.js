...
var MotionSensor = /** @class */ (function () {
    function MotionSensor(hostRef) {
    ...
    MotionSensor.prototype.componentDidLoad = function () {
        ...
        this.lastMovement = this.presence.pipe(filter(function (v) { return v; }), map(function () { return Date.now(); }));
        var _switch = this.presence.pipe(pairwise(), filter(function (_a) {
            var v1 = _a[0], v2 = _a[1];
            return v1 !== v2;
        }));
        _switch
            ...
            var v1 = _a[0], v2 = _a[1];
            return v1 && !v2;
        }), tap(function () { return console.log("switch off"); }), mergeMap(function () { return from(fetch("http://" + _this.raspberry + ":8080/api/monitor/off", {
            mode: 'no-cors'
        ...
        _switch
            ...
            var v1 = _a[0], v2 = _a[1];
            return v2 && !v1;
        }), tap(function () { return console.log("switch on"); }), mergeMap(function () { return from(fetch("http://" + _this.raspberry + ":8080/api/monitor/on", {
            mode: 'no-cors'
        })); }), takeUntil(this.onDestroy$))
            .subscribe();
    };
    MotionSensor.prototype.componentDidUnload = function () {
        this.onDestroy$.next();
    };
    Object.defineProperty(MotionSensor, "style", {
...
export { MotionSensor as hue_motion_sensor };
